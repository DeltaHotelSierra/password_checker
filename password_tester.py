...
class PasswordStrengthTester:
    ...
    def setup_ui(self):
        ...
        tk.Label(input_frame, text="Enter Password:", font=("Arial", 12)).pack(anchor="w")
        ...
        tk.Label(strength_frame, text="Strength:", font=("Arial", 12, "bold")).pack(anchor="w")
        ...
        tk.Label(criteria_frame, text="Password Requirements:", font=("Arial", 12, "bold")).pack(anchor="w")
    ...
    def update_ui(self, strength, score, criteria_met):
        ...
        self.strength_label.config(text=strength, fg=self.strength_colors[strength])
